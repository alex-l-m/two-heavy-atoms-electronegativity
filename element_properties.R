...
number <- read_csv('WolframAlpha--atomic_number_of_hydrogen__carbon__nitrogen__oxygen__fluorine__silicon__phosphorus__sulfur__chlorine______2023_12_14_22_59.csv', col_names = c('1', '2', 'element', '3', 'atomic_number', '4'), col_types = cols(element = col_character(), atomic_number = col_integer(), .default = col_character())) |>
    select(element, atomic_number)

# One or two letter symbol of the element, corresponding to the full element string
symbol <- read_csv('WolframAlpha--atomic_symbol_of_hydrogen__carbon__nitrogen__oxygen__fluorine__silicon__phosphorus__sulfur__chlorine______2023_12_14_23_00.csv', col_names = c('element', '1', 'symbol', '2')) |>
...
wa_ea <- read_csv('WolframAlpha--electron_affinity_of_hydrogen__carbon__nitrogen__oxygen__fluorine__silicon__phosphorus__sulfur__chlorine______2023_12_14_23_00.csv', col_names = c('rownum', '?', 'element', '?', 'electron_affinity', 'unit')) |>
...
wa_ip <- read_csv('WolframAlpha--first_ionization_potential_of_hydrogen__carbon__nitrogen__oxygen__fluorine__silicon__phosphorus__sulfur__chlorine______2023_12_14_23_01.csv', col_names = c('rownum', '?', 'element', '?', 'ionization_potential', 'unit')) |>
