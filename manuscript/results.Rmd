...
For each material, a series of simulations were performed with successively stronger potentials until both atoms were neutral.
...
If the Hirshfeld-I weight functions were constant between the frames, $\Delta \chi$ would simply be $2 \lambda$, and the electronegativity difference could the read off from the input settings of the simulations without even looking at the output.
