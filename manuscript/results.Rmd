...
An electrical potential was applied that was positive at the donor atom and negative at the acceptor, to draw electron density back to the donor (Figure \@ref(fig:dataset-illustration-figure)A). The potential was of the form from Equation \@ref(eq:TwoAtomPotentialSummary).
...
In each of these frames of the series, the weight functions from the previous frame were used to define the potential according to Equation \@ref(eq:TwoAtomPotentialSummary).
