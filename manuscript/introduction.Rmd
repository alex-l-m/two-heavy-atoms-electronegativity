...
A trend in the development of these datasets has been inclusion of increasingly distorted geometries.
In organic chemistry, conformer generation is standard practice, but for crystal structures, datasets progressed from having only equilibrium geometries, to including relaxation paths, and most recently to inclusion of more distorted off-equilibrium geometries.
Highly distorted geometries not only help the model learn configurations that may appear during simulations, but even help prediction of properties for the equilibrium geometry.
Off-equilibrium geometries are annotated with forces for each atom, and the use of forces assists in training, relative to training with only the energies.
