...
With a non-linear model, solving for equalized electronegativities is not as simple as solving the linear system from EEq, but it still can be accomplished by iterative root-finding methods such as Newton's method.
