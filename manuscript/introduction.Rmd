...
Including electron densities distorted by external potentials could help models generalize to chemical environments not directly present in the training data.
...
The familiar concept of an electronegativity associated with an element is recovered by considering the electronegativity $\chi(0)$ of a neutral atom, which (ignoring technicalities) turns out to be the Mulliken electronegativity.
