...
The EEM is theoretically rooted in conceptual density functional theory (DFT), in which concepts of chemistry are defined in terms of concepts from DFT [@geerlingsconceptualDFTreview].
...
Defined this way, electronegativity $\chi$ is an increasing function of charge $q$, $\chi(q)$.
For example, the fluorine atom is very electronegative (high $\chi(0)$), but the fluorine anion less so (smaller $\chi(-1)$).
Considering the electronegativity $\chi(0)$ of a neutral atom, and approximating the derivative with a difference, yields the familiar Mulliken electronegativity.
The derivative $\chi'(q)$ was defined as the hardness $\eta$, which provides a conceptual DFT definition for the hardness from the hard and soft acids and bases theory [@parrAbsoluteHardness].
