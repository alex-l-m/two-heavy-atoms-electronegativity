...
In the past few years, datasets of the scale required for machine learning have been released for both materials and molecules, including the distorted structures and force calculations required for training an MLIP.
...
Besides forces, some datasets also include the charges of each atom.
