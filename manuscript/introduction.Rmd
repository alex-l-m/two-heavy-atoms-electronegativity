...
That is, the parameters of the model, whether the element-specific $\chi^0$ and $\eta$ values of a classical QEq model or the much larger number of parameters used by a modern ML model to assign environment-dependent $\chi^0$ and $\eta$, are determined by minimizing a loss function.
