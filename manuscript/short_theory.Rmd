...
The estimate of charge is obtained by electronegativity equalization, that is, setting $\widehat{\Delta \chi}$ to zero in Equation \@ref(eq:QEqLinearModelSummary), which after solving for $q_A$ yields
\begin{equation}
