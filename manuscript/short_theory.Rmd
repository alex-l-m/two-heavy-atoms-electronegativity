...
In the Supplementary Theory all results are derived for an arbitrary number of atoms and specialized for the special case of two atoms.
In what follows we give the formulas derived, where appropriate in the two-atom special case.

## Defining atomic charge

The charge definition we use is our primitive Hirshfeld-I method, defined in full in Supplementary Theory section \@ref(sec:primitive-hirshfeld-i).
...
To define electronegativities, we consider the energy $\energyNuc$ (defined formally in the Supplementary Theory section \@ref(sec:definition-of-energy)), which includes the Coulomb potential of the nuclei but not the imposed potential.
...
\end{equation}
where $\avgWeightDerivSubscript{A}{A}{N}$ is the derivative of the weight function integrated against the electron density, discussed in more detail in the Supplementary Theory section \@ref(sec:accounting-for-boundary-shift).
