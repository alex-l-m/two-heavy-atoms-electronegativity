...
Following the approach of conceptual density functional theory we have identified the atomic electronegativity with the chemical potential, and, in the terminology of [@kittel1980thermal], measured this internal chemical potential using an external chemical potential from an imposed electric field.
...
Obtaining pairs of a charge and in an electronegativity opens up the possibility of training an empirical or machine learning model to map charge to electronegativity.
