...
Although we have not definitively established the advantages of $\chi$-prediction, it is important to raise the question to determine if the next generation of open machine learning datasets should include not just forces and charges, but also electronegativities.
