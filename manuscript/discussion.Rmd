...
The foundational physical approximation underlying the QEq method is that $\chi$ is a linear function of $q$, as given by \eqref{eq:LinearModel}.
But the critical property of this formula that enables the use of least-squares linear regression is that $\chi$ is a linear function of the QEq parameters.
